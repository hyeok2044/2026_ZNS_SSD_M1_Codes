...
consumer: consumer.c consumer_options.c consumer_options.h stats_logger.c stats_logger.h
	$(CC) $(CFLAGS) consumer.c consumer_options.c stats_logger.c -o $@ $(LDLIBS)
